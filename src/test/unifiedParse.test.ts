...
describe('unifiedParse', () => {
  ...
  describe('integerCodeToOpData and opDataToIntegerCode', () => {
  ...
  describe('parseUnifiedHeader', () => {
    ...
    it('should handle V1 headerless case', () => {
      const header1 = parseUnifiedHeader('1005;2006;3007');
      expect(header1.version).toBe('V1');
      expect(header1.type).toBe('RAM');
      expect(header1.raw).toBe('');

      const header2 = parseUnifiedHeader('1005\n2006\n3007');
      expect(header2.version).toBe('V1');
      expect(header2.type).toBe('RAM');
      expect(header2.raw).toBe('');
    });
